...
//   const HabitSelectionScreen({super.key, required this.selectedHabits});
...
//                         final isSelected =
//                             widget.selectedHabits.contains(habit['id']);
//                         return _HabitChip(
//                           name: habit['name'],
//                           icon: habit['icon'],
//                           selected: isSelected,
...
//                             setState(() {
//                               if (isSelected) {
//                                 widget.selectedHabits.remove(habit['id']);
//                               } else {
//                                 widget.selectedHabits.add(habit['id']);
//                               }
//                             });
//                           },
//                         );
